# Generated by Django 3.2 on 2021-06-06 03:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('social', '0012_notas_parciales_primer_lapso_cedula'),
    ]

    operations = [
        migrations.CreateModel(
            name='Notas_parciales_tercer_Lapso',
            fields=[
        ...
        migrations.CreateModel(
            name='Notas_parciales_segundo_Lapso',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cedula', models.IntegerField(max_length=2)),
                ('lapso', models.CharField(max_length=50)),
